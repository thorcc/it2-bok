...
3. Vis år på en fin måte.
4. Lag et plott som viser vinnere og nasjonalitet
...
3. Lag en tabell med antall land som har Engelsk som språk.
4. Lag et stolpediagram (barplot) som viser språk og antall som land som har det språket som offisielt språk.
