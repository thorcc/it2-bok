...
1. Hvorfor er det Bruker-klassen som lager tweets, og ikke Twitter?
2. Hvorfor må `tweets` være en instansvariabel?
3. Hva er forskjellen på ansvarene til Bruker og Tweet?
